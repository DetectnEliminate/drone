...
import { 
    View, FlatList, Image, Text} from 'react-native';
...
export default function Cardpanel() {
   return (
    <View style={gStyle.panelcard} >
        <View style={gStyle.panellist} >
            <FlatList
                horizontal
